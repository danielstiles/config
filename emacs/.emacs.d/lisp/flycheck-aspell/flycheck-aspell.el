...
;; Package-Commit: 2e754a1ec8c423a3356443ab8128aa43a1a860b7
;; Package-Version: 20200830.2357
...
(defcustom flycheck-aspell-suggest-limit nil
  "How many word suggestions to return."
  :group 'flycheck
  :type '(integer :tag "Number of suggestions")
  :safe #'integerp)
      ...
      (push
       (flycheck-error-new-at
        ...
        (if (null suggestions)
    	    (concat "Unknown: " word)
          (concat "Suggest: " word " -> "
                  (if (not flycheck-aspell-suggest-limit) suggestions
                           (string-join (let ((s (split-string suggestions ", ")))
                                          (butlast s (- (length s) flycheck-aspell-suggest-limit))) ", "))))
        :checker checker
        :buffer buffer
